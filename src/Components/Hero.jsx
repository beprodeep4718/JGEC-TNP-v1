...
const Hero = () => {
  return (
    <div className="w-full relative h-screen flex items-center justify-center pt-20 px-20 py-10 overflow-hidden">
      <div className="w-full flex items-end justify-center gap-6">
        <div className="w-[45%] flex flex-col items-center justify-center pl-20 gap-4">
          ...
          <div className="w-full flex items-center justify-center gap-4">
            <h1 className="bg-primary text-xl text-center text-white px-4 py-4 flex-1">
              tnpmail@jgec.an.in
            </h1>
            <h1 className="bg-primary text-xl text-center text-white px-4 py-4 flex-1">
              9876543210
